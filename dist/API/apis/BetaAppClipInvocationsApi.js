...
exports.BetaAppClipInvocationsApi = void 0;
/* tslint:disable */
/* eslint-disable */
/**
 ...
 *
 */
class BetaAppClipInvocationsApi extends runtime.BaseAPI {
    /**
     */
    betaAppClipInvocationsCreateInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.BetaAppClipInvocationCreateRequestToJSON)(requestParameters.betaAppClipInvocationCreateRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.BetaAppClipInvocationResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    betaAppClipInvocationsCreateInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.betaAppClipInvocationsCreateInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    betaAppClipInvocationsDeleteInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    /**
     */
    betaAppClipInvocationsDeleteInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.betaAppClipInvocationsDeleteInstanceRaw(requestParameters, initOverrides);
        });
    }
    /**
     */
    betaAppClipInvocationsGetInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.id === null || requestParameters.id === undefined) {
    ...
    /**
     */
    betaAppClipInvocationsGetInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.betaAppClipInvocationsGetInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    betaAppClipInvocationsUpdateInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.id === null || requestParameters.id === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.BetaAppClipInvocationUpdateRequestToJSON)(requestParameters.betaAppClipInvocationUpdateRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.BetaAppClipInvocationResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    betaAppClipInvocationsUpdateInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.betaAppClipInvocationsUpdateInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
exports.BetaAppClipInvocationsApi = BetaAppClipInvocationsApi;
;
;
//# sourceMappingURL=BetaAppClipInvocationsApi.js.map