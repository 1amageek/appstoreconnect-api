...
exports.BetaAppReviewSubmissionsApi = void 0;
/* tslint:disable */
/* eslint-disable */
/**
 ...
 *
 */
class BetaAppReviewSubmissionsApi extends runtime.BaseAPI {
    /**
     */
    betaAppReviewSubmissionsBuildGetToOneRelatedRaw(requestParameters, initOverrides) {
    ...
    /**
     */
    betaAppReviewSubmissionsBuildGetToOneRelated(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.betaAppReviewSubmissionsBuildGetToOneRelatedRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    betaAppReviewSubmissionsCreateInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.BetaAppReviewSubmissionCreateRequestToJSON)(requestParameters.betaAppReviewSubmissionCreateRequest),
            }, initOverrides);
    ...
    /**
     */
    betaAppReviewSubmissionsCreateInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.betaAppReviewSubmissionsCreateInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    betaAppReviewSubmissionsGetCollectionRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.BetaAppReviewSubmissionsResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    betaAppReviewSubmissionsGetCollection(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.betaAppReviewSubmissionsGetCollectionRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    betaAppReviewSubmissionsGetInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.id === null || requestParameters.id === undefined) {
    ...
    /**
     */
    betaAppReviewSubmissionsGetInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.betaAppReviewSubmissionsGetInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
exports.BetaAppReviewSubmissionsApi = BetaAppReviewSubmissionsApi;
;
;
;
;
...
;
;
//# sourceMappingURL=BetaAppReviewSubmissionsApi.js.map