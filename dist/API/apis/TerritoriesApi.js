 ...
 *
 */
class TerritoriesApi extends runtime.BaseAPI {
    /**
     */
    territoriesGetCollectionRaw(requestParameters, initOverrides) {
    ...
    /**
     */
    territoriesGetCollection(requestParameters = {}, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.territoriesGetCollectionRaw(requestParameters, initOverrides);
