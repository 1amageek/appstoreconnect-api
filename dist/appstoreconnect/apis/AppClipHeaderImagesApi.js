...
exports.AppClipHeaderImagesApi = void 0;
/* tslint:disable */
/* eslint-disable */
/**
 ...
 *
 */
class AppClipHeaderImagesApi extends runtime.BaseAPI {
    /**
     */
    appClipHeaderImagesCreateInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.AppClipHeaderImageCreateRequestToJSON)(requestParameters.appClipHeaderImageCreateRequest),
            }, initOverrides);
    ...
    /**
     */
    appClipHeaderImagesCreateInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.appClipHeaderImagesCreateInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    appClipHeaderImagesDeleteInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    /**
     */
    appClipHeaderImagesDeleteInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.appClipHeaderImagesDeleteInstanceRaw(requestParameters, initOverrides);
        });
    }
    /**
     */
    appClipHeaderImagesGetInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.id === null || requestParameters.id === undefined) {
    ...
    /**
     */
    appClipHeaderImagesGetInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.appClipHeaderImagesGetInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    appClipHeaderImagesUpdateInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.id === null || requestParameters.id === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.AppClipHeaderImageUpdateRequestToJSON)(requestParameters.appClipHeaderImageUpdateRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.AppClipHeaderImageResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    appClipHeaderImagesUpdateInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.appClipHeaderImagesUpdateInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
exports.AppClipHeaderImagesApi = AppClipHeaderImagesApi;
;
;
//# sourceMappingURL=AppClipHeaderImagesApi.js.map