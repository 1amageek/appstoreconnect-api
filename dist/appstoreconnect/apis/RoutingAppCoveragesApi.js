...
exports.RoutingAppCoveragesApi = void 0;
/* tslint:disable */
/* eslint-disable */
/**
 ...
 *
 */
class RoutingAppCoveragesApi extends runtime.BaseAPI {
    /**
     */
    routingAppCoveragesCreateInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.RoutingAppCoverageCreateRequestToJSON)(requestParameters.routingAppCoverageCreateRequest),
            }, initOverrides);
    ...
    /**
     */
    routingAppCoveragesCreateInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.routingAppCoveragesCreateInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    routingAppCoveragesDeleteInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    /**
     */
    routingAppCoveragesDeleteInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.routingAppCoveragesDeleteInstanceRaw(requestParameters, initOverrides);
        });
    }
    /**
     */
    routingAppCoveragesGetInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.id === null || requestParameters.id === undefined) {
    ...
    /**
     */
    routingAppCoveragesGetInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.routingAppCoveragesGetInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    routingAppCoveragesUpdateInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.id === null || requestParameters.id === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.RoutingAppCoverageUpdateRequestToJSON)(requestParameters.routingAppCoverageUpdateRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.RoutingAppCoverageResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    routingAppCoveragesUpdateInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.routingAppCoveragesUpdateInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
exports.RoutingAppCoveragesApi = RoutingAppCoveragesApi;
;
;
//# sourceMappingURL=RoutingAppCoveragesApi.js.map