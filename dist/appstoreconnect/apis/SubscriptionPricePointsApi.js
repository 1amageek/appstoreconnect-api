...
exports.SubscriptionPricePointsApi = void 0;
/* tslint:disable */
/* eslint-disable */
/**
 ...
 *
 */
class SubscriptionPricePointsApi extends runtime.BaseAPI {
    /**
     */
    subscriptionPricePointsEqualizationsGetToManyRelatedRaw(requestParameters, initOverrides) {
    ...
    /**
     */
    subscriptionPricePointsEqualizationsGetToManyRelated(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.subscriptionPricePointsEqualizationsGetToManyRelatedRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     */
    subscriptionPricePointsGetInstanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.id === null || requestParameters.id === undefined) {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.SubscriptionPricePointResponseFromJSON)(jsonValue));
        });
    }
    /**
     */
    subscriptionPricePointsGetInstance(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.subscriptionPricePointsGetInstanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
exports.SubscriptionPricePointsApi = SubscriptionPricePointsApi;
;
;
;
;
;
//# sourceMappingURL=SubscriptionPricePointsApi.js.map