...
export class AppInfoLocalizationsApi {
     ...
     */
    public async appInfoLocalizationsCreateInstance (appInfoLocalizationCreateRequest: AppInfoLocalizationCreateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AppInfoLocalizationResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AppInfoLocalizationResponse;  }>((resolve, reject) => {
     ...
     */
    public async appInfoLocalizationsDeleteInstance (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     */
    public async appInfoLocalizationsGetInstance (id: string, fieldsAppInfoLocalizations?: Array<'appInfo' | 'locale' | 'name' | 'privacyChoicesUrl' | 'privacyPolicyText' | 'privacyPolicyUrl' | 'subtitle'>, include?: Array<'appInfo'>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AppInfoLocalizationResponse;  }> {
        const localVarPath = this.basePath + '/v1/appInfoLocalizations/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async appInfoLocalizationsUpdateInstance (id: string, appInfoLocalizationUpdateRequest: AppInfoLocalizationUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AppInfoLocalizationResponse;  }> {
        const localVarPath = this.basePath + '/v1/appInfoLocalizations/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
