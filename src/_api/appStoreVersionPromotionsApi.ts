...
export class AppStoreVersionPromotionsApi {
    ...
    public setApiKey(key: AppStoreVersionPromotionsApiApiKeys, value: string) {
     ...
     */
    public async appStoreVersionPromotionsCreateInstance (appStoreVersionPromotionCreateRequest: AppStoreVersionPromotionCreateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AppStoreVersionPromotionResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AppStoreVersionPromotionResponse;  }>((resolve, reject) => {
