...
export enum InAppPurchaseContentsApiApiKeys {
}

export class InAppPurchaseContentsApi {
    ...
    public setApiKey(key: InAppPurchaseContentsApiApiKeys, value: string) {
        (this.authentications as any)[InAppPurchaseContentsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async inAppPurchaseContentsGetInstance (id: string, fieldsInAppPurchaseContents?: Array<'fileName' | 'fileSize' | 'inAppPurchaseV2' | 'lastModifiedDate' | 'url'>, include?: Array<'inAppPurchaseV2'>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InAppPurchaseContentResponse;  }> {
        const localVarPath = this.basePath + '/v1/inAppPurchaseContents/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling inAppPurchaseContentsGetInstance.');
        }
