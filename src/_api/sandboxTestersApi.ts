...
export class SandboxTestersApi {
    ...
    public setApiKey(key: SandboxTestersApiApiKeys, value: string) {
     ...
     */
    public async sandboxTestersGetCollection (fieldsSandboxTesters?: Array<'acAccountName' | 'applePayCompatible' | 'firstName' | 'interruptPurchases' | 'lastName' | 'subscriptionRenewalRate' | 'territory'>, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SandboxTestersV2Response;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SandboxTestersV2Response;  }>((resolve, reject) => {
     ...
     */
    public async sandboxTestersUpdateInstance (id: string, sandboxTesterV2UpdateRequest: SandboxTesterV2UpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SandboxTesterV2Response;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SandboxTesterV2Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
