...
export class AppClipAdvancedExperienceImagesApi {
     ...
     */
    public async appClipAdvancedExperienceImagesCreateInstance(params: {
        ...
        const { appClipAdvancedExperienceImageCreateRequest, options } = params;
     ...
     */
    public async appClipAdvancedExperienceImagesGetInstance(params: {
        id: string;
        ...
        const { id, fieldsAppClipAdvancedExperienceImages, options } = params;
     ...
     */
    public async appClipAdvancedExperienceImagesUpdateInstance(params: {
        id: string;
        ...
        const { id, appClipAdvancedExperienceImageUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/appClipAdvancedExperienceImages/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
