...
export class AppCustomProductPagesApi {
    ...
    public setApiKey(params: {
        key: AppCustomProductPagesApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async appCustomProductPagesAppCustomProductPageVersionsGetToManyRelated(params: {
        id: string;
        ...
        const { id, filterState, fieldsAppCustomProductPageLocalizations, fieldsAppCustomProductPageVersions, fieldsAppCustomProductPages, limit, limitAppCustomProductPageLocalizations, include, options } = params;
     ...
     */
    public async appCustomProductPagesCreateInstance(params: {
        ...
        const { appCustomProductPageCreateRequest, options } = params;
     ...
     * @param id the id of the requested resource
     */
    public async appCustomProductPagesDeleteInstance(params: {
        id: string;
        options: {
            headers: {
                [name: string]: string;
     ...
     */
    public async appCustomProductPagesGetInstance(params: {
        id: string;
        fieldsAppCustomProductPages?: Array<'app' | 'appCustomProductPageVersions' | 'appStoreVersionTemplate' | 'customProductPageTemplate' | 'name' | 'url' | 'visible'>;
        ...
        const { id, fieldsAppCustomProductPages, include, fieldsAppCustomProductPageVersions, limitAppCustomProductPageVersions, options } = params;
        const localVarPath = this.basePath + '/v1/appCustomProductPages/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async appCustomProductPagesUpdateInstance(params: {
        id: string;
        ...
        const { id, appCustomProductPageUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/appCustomProductPages/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
