...
export class AppEncryptionDeclarationsApi {
    ...
    public setApiKey(params: {
        key: AppEncryptionDeclarationsApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async appEncryptionDeclarationsAppEncryptionDeclarationDocumentGetToOneRelated(params: {
        id: string;
     ...
     */
    public async appEncryptionDeclarationsAppGetToOneRelated(params: {
        id: string;
     ...
     */
    public async appEncryptionDeclarationsBuildsCreateToManyRelationship(params: {
        id: string;
        ...
        const { id, appEncryptionDeclarationBuildsLinkagesRequest, options } = params;
     ...
     */
    public async appEncryptionDeclarationsGetCollection(params: {
        ...
        limit?: number;
        include?: Array<'app' | 'appEncryptionDeclarationDocument' | 'builds'>;
        fieldsAppEncryptionDeclarationDocuments?: Array<'appEncryptionDeclaration' | 'assetDeliveryState' | 'assetToken' | 'downloadUrl' | 'fileName' | 'fileSize' | 'sourceFileChecksum' | 'uploadOperations' | 'uploaded'>;
        fieldsApps?: Array<'appAvailability' | 'appClips' | 'appCustomProductPages' | 'appEvents' | 'appInfos' | 'appPricePoints' | 'appPriceSchedule' | 'appStoreVersions' | 'availableInNewTerritories' | 'availableTerritories' | 'betaAppLocalizations' | 'betaAppReviewDetail' | 'betaGroups' | 'betaLicenseAgreement' | 'betaTesters' | 'builds' | 'bundleId' | 'ciProduct' | 'contentRightsDeclaration' | 'customerReviews' | 'endUserLicenseAgreement' | 'gameCenterEnabledVersions' | 'inAppPurchases' | 'inAppPurchasesV2' | 'isOrEverWasMadeForKids' | 'name' | 'perfPowerMetrics' | 'preOrder' | 'preReleaseVersions' | 'pricePoints' | 'prices' | 'primaryLocale' | 'promotedPurchases' | 'reviewSubmissions' | 'sku' | 'subscriptionGracePeriod' | 'subscriptionGroups' | 'subscriptionStatusUrl' | 'subscriptionStatusUrlForSandbox' | 'subscriptionStatusUrlVersion' | 'subscriptionStatusUrlVersionForSandbox'>;
        limitBuilds?: number;
        options: {
        ...
        const { filterPlatform, filterApp, filterBuilds, fieldsAppEncryptionDeclarations, limit, include, fieldsAppEncryptionDeclarationDocuments, fieldsApps, limitBuilds, options } = params;
     ...
     * @param limitBuilds maximum number of related builds returned (when they are included)
     */
    public async appEncryptionDeclarationsGetInstance(params: {
        id: string;
        fieldsAppEncryptionDeclarations?: Array<'app' | 'appDescription' | 'appEncryptionDeclarationDocument' | 'appEncryptionDeclarationState' | 'availableOnFrenchStore' | 'builds' | 'codeValue' | 'containsProprietaryCryptography' | 'containsThirdPartyCryptography' | 'createdDate' | 'documentName' | 'documentType' | 'documentUrl' | 'exempt' | 'platform' | 'uploadedDate' | 'usesEncryption'>;
        include?: Array<'app' | 'appEncryptionDeclarationDocument' | 'builds'>;
        fieldsAppEncryptionDeclarationDocuments?: Array<'appEncryptionDeclaration' | 'assetDeliveryState' | 'assetToken' | 'downloadUrl' | 'fileName' | 'fileSize' | 'sourceFileChecksum' | 'uploadOperations' | 'uploaded'>;
        ...
        const { id, fieldsAppEncryptionDeclarations, include, fieldsAppEncryptionDeclarationDocuments, fieldsApps, limitBuilds, options } = params;
