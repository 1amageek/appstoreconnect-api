...
export class AppPreOrdersApi {
     ...
     */
    public async appPreOrdersCreateInstance(params: {
        ...
        const { appPreOrderCreateRequest, options } = params;
     ...
     */
    public async appPreOrdersDeleteInstance(params: {
        id: string;
        options: {
            headers: {
                [name: string]: string;
     ...
     */
    public async appPreOrdersGetInstance(params: {
        id: string;
        ...
        const { id, fieldsAppPreOrders, include, options } = params;
        const localVarPath = this.basePath + '/v1/appPreOrders/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async appPreOrdersUpdateInstance(params: {
        id: string;
        ...
        const { id, appPreOrderUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/appPreOrders/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
