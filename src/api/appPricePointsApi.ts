...
export class AppPricePointsApi {
     ...
     */
    public async appPricePointsEqualizationsGetToManyRelated(params: {
        id: string;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async appPricePointsGetInstance(params: {
        id: string;
        fieldsAppPricePoints?: Array<'app' | 'customerPrice' | 'equalizations' | 'proceeds' | 'territory'>;
        include?: Array<'app' | 'territory'>;
        options: {
        ...
        response: http.IncomingMessage;
        body: AppPricePointV3Response;
    }> {
        const { id, fieldsAppPricePoints, include, options } = params;
