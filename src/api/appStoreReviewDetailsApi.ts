...
export class AppStoreReviewDetailsApi {
    ...
    public setApiKey(params: {
        key: AppStoreReviewDetailsApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async appStoreReviewDetailsAppStoreReviewAttachmentsGetToManyRelated(params: {
        id: string;
        ...
        body: AppStoreReviewAttachmentsResponse;
    }> {
        const { id, fieldsAppStoreReviewDetails, fieldsAppStoreReviewAttachments, limit, include, options } = params;
     ...
     */
    public async appStoreReviewDetailsCreateInstance(params: {
        ...
        const { appStoreReviewDetailCreateRequest, options } = params;
     ...
     */
    public async appStoreReviewDetailsGetInstance(params: {
        id: string;
        fieldsAppStoreReviewDetails?: Array<'appStoreReviewAttachments' | 'appStoreVersion' | 'contactEmail' | 'contactFirstName' | 'contactLastName' | 'contactPhone' | 'demoAccountName' | 'demoAccountPassword' | 'demoAccountRequired' | 'notes'>;
        ...
        const { id, fieldsAppStoreReviewDetails, include, fieldsAppStoreReviewAttachments, limitAppStoreReviewAttachments, options } = params;
     ...
     */
    public async appStoreReviewDetailsUpdateInstance(params: {
        id: string;
        ...
        const { id, appStoreReviewDetailUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/appStoreReviewDetails/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
