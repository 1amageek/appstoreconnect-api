...
export class AppStoreVersionExperimentTreatmentLocalizationsApi {
    ...
    public setApiKey(key: AppStoreVersionExperimentTreatmentLocalizationsApiApiKeys, value: string) {
     ...
     */
    public async appStoreVersionExperimentTreatmentLocalizationsCreateInstance (appStoreVersionExperimentTreatmentLocalizationCreateRequest: AppStoreVersionExperimentTreatmentLocalizationCreateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AppStoreVersionExperimentTreatmentLocalizationResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AppStoreVersionExperimentTreatmentLocalizationResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @param id the id of the requested resource
     */
    public async appStoreVersionExperimentTreatmentLocalizationsDeleteInstance (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
