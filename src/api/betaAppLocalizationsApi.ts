...
export class BetaAppLocalizationsApi {
    ...
    public setApiKey(params: {
        key: BetaAppLocalizationsApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async betaAppLocalizationsAppGetToOneRelated(params: {
        id: string;
     ...
     */
    public async betaAppLocalizationsCreateInstance(params: {
        ...
        const { betaAppLocalizationCreateRequest, options } = params;
     ...
     * @param id the id of the requested resource
     */
    public async betaAppLocalizationsDeleteInstance(params: {
        id: string;
        options: {
            headers: {
                [name: string]: string;
     ...
     * @param fieldsApps the fields to include for returned resources of type apps
     */
    public async betaAppLocalizationsGetCollection(params: {
        ...
        const { filterLocale, filterApp, fieldsBetaAppLocalizations, limit, include, fieldsApps, options } = params;
        const localVarPath = this.basePath + '/v1/betaAppLocalizations';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param fieldsApps the fields to include for returned resources of type apps
     */
    public async betaAppLocalizationsGetInstance(params: {
        id: string;
        fieldsBetaAppLocalizations?: Array<'app' | 'description' | 'feedbackEmail' | 'locale' | 'marketingUrl' | 'privacyPolicyUrl' | 'tvOsPrivacyPolicy'>;
        include?: Array<'app'>;
        fieldsApps?: Array<'appAvailability' | 'appClips' | 'appCustomProductPages' | 'appEvents' | 'appInfos' | 'appPricePoints' | 'appPriceSchedule' | 'appStoreVersions' | 'availableInNewTerritories' | 'availableTerritories' | 'betaAppLocalizations' | 'betaAppReviewDetail' | 'betaGroups' | 'betaLicenseAgreement' | 'betaTesters' | 'builds' | 'bundleId' | 'ciProduct' | 'contentRightsDeclaration' | 'customerReviews' | 'endUserLicenseAgreement' | 'gameCenterEnabledVersions' | 'inAppPurchases' | 'inAppPurchasesV2' | 'isOrEverWasMadeForKids' | 'name' | 'perfPowerMetrics' | 'preOrder' | 'preReleaseVersions' | 'pricePoints' | 'prices' | 'primaryLocale' | 'promotedPurchases' | 'reviewSubmissions' | 'sku' | 'subscriptionGracePeriod' | 'subscriptionGroups' | 'subscriptionStatusUrl' | 'subscriptionStatusUrlForSandbox' | 'subscriptionStatusUrlVersion' | 'subscriptionStatusUrlVersionForSandbox'>;
        ...
        const { id, fieldsBetaAppLocalizations, include, fieldsApps, options } = params;
        const localVarPath = this.basePath + '/v1/betaAppLocalizations/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async betaAppLocalizationsUpdateInstance(params: {
        id: string;
        ...
        const { id, betaAppLocalizationUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/betaAppLocalizations/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
