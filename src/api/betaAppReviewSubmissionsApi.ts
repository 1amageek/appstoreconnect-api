...
export class BetaAppReviewSubmissionsApi {
    ...
    public setApiKey(params: {
        key: BetaAppReviewSubmissionsApiApiKeys;
        value: string;
    }) {
        const { key, value } = params;
        (this.authentications as any)[BetaAppReviewSubmissionsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async betaAppReviewSubmissionsBuildGetToOneRelated(params: {
        id: string;
        ...
        const localVarPath = this.basePath + '/v1/betaAppReviewSubmissions/{id}/build'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling betaAppReviewSubmissionsBuildGetToOneRelated.');
        }
     ...
     */
    public async betaAppReviewSubmissionsCreateInstance(params: {
        ...
        const { betaAppReviewSubmissionCreateRequest, options } = params;
        ...
        if (betaAppReviewSubmissionCreateRequest === null || betaAppReviewSubmissionCreateRequest === undefined) {
            throw new Error('Required parameter betaAppReviewSubmissionCreateRequest was null or undefined when calling betaAppReviewSubmissionsCreateInstance.');
        }
        (<any>Object).assign(localVarHeaderParams, options.headers);
        let localVarUseFormData = false;
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(betaAppReviewSubmissionCreateRequest, "BetaAppReviewSubmissionCreateRequest")
        };
        let authenticationPromise = Promise.resolve();
        if (this.authentications.itcBearerToken.accessToken) {
            authenticationPromise = authenticationPromise.then(() => this.authentications.itcBearerToken.applyToRequest(localVarRequestOptions));
     ...
     * @param fieldsBuilds the fields to include for returned resources of type builds
     */
    public async betaAppReviewSubmissionsGetCollection(params: {
        ...
        const { filterBuild, filterBetaReviewState, fieldsBetaAppReviewSubmissions, limit, include, fieldsBuilds, options } = params;
        const localVarPath = this.basePath + '/v1/betaAppReviewSubmissions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (filterBuild === null || filterBuild === undefined) {
            throw new Error('Required parameter filterBuild was null or undefined when calling betaAppReviewSubmissionsGetCollection.');
        }
        if (filterBetaReviewState !== undefined) {
            localVarQueryParameters['filter[betaReviewState]'] = ObjectSerializer.serialize(filterBetaReviewState, "Array<'WAITING_FOR_REVIEW' | 'IN_REVIEW' | 'REJECTED' | 'APPROVED'>");
        }
            ...
            return new Promise<{
                ...
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "BetaAppReviewSubmissionsResponse");
                            resolve({ response: response, body: body });
                        }
                        else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param fieldsBuilds the fields to include for returned resources of type builds
     */
    public async betaAppReviewSubmissionsGetInstance(params: {
        id: string;
        fieldsBetaAppReviewSubmissions?: Array<'betaReviewState' | 'build' | 'submittedDate'>;
        include?: Array<'build'>;
        fieldsBuilds?: Array<'app' | 'appEncryptionDeclaration' | 'appStoreVersion' | 'betaAppReviewSubmission' | 'betaBuildLocalizations' | 'betaGroups' | 'buildAudienceType' | 'buildBetaDetail' | 'buildBundles' | 'computedMinMacOsVersion' | 'diagnosticSignatures' | 'expirationDate' | 'expired' | 'iconAssetToken' | 'icons' | 'individualTesters' | 'lsMinimumSystemVersion' | 'minOsVersion' | 'perfPowerMetrics' | 'preReleaseVersion' | 'processingState' | 'uploadedDate' | 'usesNonExemptEncryption' | 'version'>;
        ...
        const { id, fieldsBetaAppReviewSubmissions, include, fieldsBuilds, options } = params;
        const localVarPath = this.basePath + '/v1/betaAppReviewSubmissions/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling betaAppReviewSubmissionsGetInstance.');
        }
        if (fieldsBetaAppReviewSubmissions !== undefined) {
            localVarQueryParameters['fields[betaAppReviewSubmissions]'] = ObjectSerializer.serialize(fieldsBetaAppReviewSubmissions, "Array<'betaReviewState' | 'build' | 'submittedDate'>");
        }
