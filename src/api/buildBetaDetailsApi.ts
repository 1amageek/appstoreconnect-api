...
export class BuildBetaDetailsApi {
    ...
    public setApiKey(params: {
        key: BuildBetaDetailsApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async buildBetaDetailsBuildGetToOneRelated(params: {
        id: string;
     ...
     * @param fieldsBuilds the fields to include for returned resources of type builds
     */
    public async buildBetaDetailsGetCollection(params: {
        ...
        response: http.IncomingMessage;
        body: BuildBetaDetailsResponse;
    }> {
        const { filterBuild, filterId, fieldsBuildBetaDetails, limit, include, fieldsBuilds, options } = params;
     ...
     * @param fieldsBuilds the fields to include for returned resources of type builds
     */
    public async buildBetaDetailsGetInstance(params: {
        id: string;
        fieldsBuildBetaDetails?: Array<'autoNotifyEnabled' | 'build' | 'externalBuildState' | 'internalBuildState'>;
        include?: Array<'build'>;
        fieldsBuilds?: Array<'app' | 'appEncryptionDeclaration' | 'appStoreVersion' | 'betaAppReviewSubmission' | 'betaBuildLocalizations' | 'betaGroups' | 'buildAudienceType' | 'buildBetaDetail' | 'buildBundles' | 'computedMinMacOsVersion' | 'diagnosticSignatures' | 'expirationDate' | 'expired' | 'iconAssetToken' | 'icons' | 'individualTesters' | 'lsMinimumSystemVersion' | 'minOsVersion' | 'perfPowerMetrics' | 'preReleaseVersion' | 'processingState' | 'uploadedDate' | 'usesNonExemptEncryption' | 'version'>;
        ...
        const { id, fieldsBuildBetaDetails, include, fieldsBuilds, options } = params;
     ...
     */
    public async buildBetaDetailsUpdateInstance(params: {
        id: string;
        ...
        const { id, buildBetaDetailUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/buildBetaDetails/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
