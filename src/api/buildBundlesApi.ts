...
export class BuildBundlesApi {
     ...
     */
    public async buildBundlesAppClipDomainCacheStatusGetToOneRelated(params: {
        id: string;
        ...
        const { id, fieldsAppClipDomainStatuses, options } = params;
     ...
     * @param fieldsAppClipDomainStatuses the fields to include for returned resources of type appClipDomainStatuses
     */
    public async buildBundlesAppClipDomainDebugStatusGetToOneRelated(params: {
        id: string;
        fieldsAppClipDomainStatuses?: Array<'domains' | 'lastUpdatedDate'>;
        options: {
            headers: {
     ...
     */
    public async buildBundlesBetaAppClipInvocationsGetToManyRelated(params: {
        id: string;
        fieldsBetaAppClipInvocations?: Array<'betaAppClipInvocationLocalizations' | 'buildBundle' | 'url'>;
        fieldsBetaAppClipInvocationLocalizations?: Array<'betaAppClipInvocation' | 'locale' | 'title'>;
        limit?: number;
        ...
        const { id, fieldsBetaAppClipInvocations, fieldsBetaAppClipInvocationLocalizations, limit, limitBetaAppClipInvocationLocalizations, include, options } = params;
     ...
     * @param limit maximum resources per page
     */
    public async buildBundlesBuildBundleFileSizesGetToManyRelated(params: {
        id: string;
        fieldsBuildBundleFileSizes?: Array<'deviceModel' | 'downloadBytes' | 'installBytes' | 'osVersion'>;
        limit?: number;
        options: {
            headers: {
                [name: string]: string;
        ...
        const { id, fieldsBuildBundleFileSizes, limit, options } = params;
