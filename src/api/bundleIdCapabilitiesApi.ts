...
export class BundleIdCapabilitiesApi {
    ...
    public setApiKey(params: {
        key: BundleIdCapabilitiesApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async bundleIdCapabilitiesCreateInstance(params: {
        ...
        const { bundleIdCapabilityCreateRequest, options } = params;
     ...
     */
    public async bundleIdCapabilitiesDeleteInstance(params: {
        id: string;
        options: {
            headers: {
                [name: string]: string;
     ...
     */
    public async bundleIdCapabilitiesUpdateInstance(params: {
        id: string;
        ...
        const { id, bundleIdCapabilityUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/bundleIdCapabilities/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
