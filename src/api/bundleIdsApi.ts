...
export class BundleIdsApi {
     ...
     */
    public async bundleIdsAppGetToOneRelated(params: {
        id: string;
     ...
     */
    public async bundleIdsBundleIdCapabilitiesGetToManyRelated(params: {
        id: string;
        fieldsBundleIdCapabilities?: Array<'bundleId' | 'capabilityType' | 'settings'>;
        limit?: number;
        options: {
            headers: {
                [name: string]: string;
        ...
        const { id, fieldsBundleIdCapabilities, limit, options } = params;
     ...
     */
    public async bundleIdsCreateInstance(params: {
        ...
        const { bundleIdCreateRequest, options } = params;
     ...
     * @param id the id of the requested resource
     */
    public async bundleIdsDeleteInstance(params: {
        id: string;
        options: {
            headers: {
                [name: string]: string;
     ...
     */
    public async bundleIdsGetCollection(params: {
        filterIdentifier?: Array<string>;
        filterName?: Array<string>;
        filterPlatform?: Array<'IOS' | 'MAC_OS'>;
        filterSeedId?: Array<string>;
        filterId?: Array<string>;
        sort?: Array<'id' | '-id' | 'identifier' | '-identifier' | 'name' | '-name' | 'platform' | '-platform' | 'seedId' | '-seedId'>;
        ...
        fieldsBundleIdCapabilities?: Array<'bundleId' | 'capabilityType' | 'settings'>;
        fieldsProfiles?: Array<'bundleId' | 'certificates' | 'createdDate' | 'devices' | 'expirationDate' | 'name' | 'platform' | 'profileContent' | 'profileState' | 'profileType' | 'uuid'>;
        fieldsApps?: Array<'appAvailability' | 'appClips' | 'appCustomProductPages' | 'appEvents' | 'appInfos' | 'appPricePoints' | 'appPriceSchedule' | 'appStoreVersions' | 'availableInNewTerritories' | 'availableTerritories' | 'betaAppLocalizations' | 'betaAppReviewDetail' | 'betaGroups' | 'betaLicenseAgreement' | 'betaTesters' | 'builds' | 'bundleId' | 'ciProduct' | 'contentRightsDeclaration' | 'customerReviews' | 'endUserLicenseAgreement' | 'gameCenterEnabledVersions' | 'inAppPurchases' | 'inAppPurchasesV2' | 'isOrEverWasMadeForKids' | 'name' | 'perfPowerMetrics' | 'preOrder' | 'preReleaseVersions' | 'pricePoints' | 'prices' | 'primaryLocale' | 'promotedPurchases' | 'reviewSubmissions' | 'sku' | 'subscriptionGracePeriod' | 'subscriptionGroups' | 'subscriptionStatusUrl' | 'subscriptionStatusUrlForSandbox' | 'subscriptionStatusUrlVersion' | 'subscriptionStatusUrlVersionForSandbox'>;
        ...
        const { filterIdentifier, filterName, filterPlatform, filterSeedId, filterId, sort, fieldsBundleIds, limit, include, fieldsBundleIdCapabilities, fieldsProfiles, fieldsApps, limitBundleIdCapabilities, limitProfiles, options } = params;
        const localVarPath = this.basePath + '/v1/bundleIds';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param limitProfiles maximum number of related profiles returned (when they are included)
     */
    public async bundleIdsGetInstance(params: {
        id: string;
        fieldsBundleIds?: Array<'app' | 'bundleIdCapabilities' | 'identifier' | 'name' | 'platform' | 'profiles' | 'seedId'>;
        include?: Array<'app' | 'bundleIdCapabilities' | 'profiles'>;
        fieldsBundleIdCapabilities?: Array<'bundleId' | 'capabilityType' | 'settings'>;
        ...
        const { id, fieldsBundleIds, include, fieldsBundleIdCapabilities, fieldsProfiles, fieldsApps, limitBundleIdCapabilities, limitProfiles, options } = params;
        const localVarPath = this.basePath + '/v1/bundleIds/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param limit maximum resources per page
     */
    public async bundleIdsProfilesGetToManyRelated(params: {
        id: string;
        fieldsProfiles?: Array<'bundleId' | 'certificates' | 'createdDate' | 'devices' | 'expirationDate' | 'name' | 'platform' | 'profileContent' | 'profileState' | 'profileType' | 'uuid'>;
        limit?: number;
        options: {
        ...
        const { id, fieldsProfiles, limit, options } = params;
     ...
     */
    public async bundleIdsUpdateInstance(params: {
        id: string;
        ...
        const { id, bundleIdUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/bundleIds/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
