...
export class CiBuildActionsApi {
     ...
     */
    public async ciBuildActionsArtifactsGetToManyRelated(params: {
        id: string;
        fieldsCiArtifacts?: Array<'downloadUrl' | 'fileName' | 'fileSize' | 'fileType'>;
        limit?: number;
        options: {
            headers: {
                [name: string]: string;
        ...
        const { id, fieldsCiArtifacts, limit, options } = params;
        const localVarPath = this.basePath + '/v1/ciBuildActions/{id}/artifacts'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling ciBuildActionsArtifactsGetToManyRelated.');
        }
        if (fieldsCiArtifacts !== undefined) {
            localVarQueryParameters['fields[ciArtifacts]'] = ObjectSerializer.serialize(fieldsCiArtifacts, "Array<'downloadUrl' | 'fileName' | 'fileSize' | 'fileType'>");
        }
        if (limit !== undefined) {
     ...
     */
    public async ciBuildActionsBuildRunGetToOneRelated(params: {
        id: string;
        ...
        const { id, fieldsScmGitReferences, fieldsCiBuildRuns, fieldsCiWorkflows, fieldsScmPullRequests, fieldsCiProducts, fieldsBuilds, limitBuilds, include, options } = params;
        const localVarPath = this.basePath + '/v1/ciBuildActions/{id}/buildRun'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling ciBuildActionsBuildRunGetToOneRelated.');
        }
     ...
     * @param fieldsCiArtifacts the fields to include for returned resources of type ciArtifacts
     */
    public async ciBuildActionsGetInstance(params: {
        id: string;
        ...
        fieldsCiBuildRuns?: Array<'actions' | 'buildRun' | 'builds' | 'cancelReason' | 'clean' | 'completionStatus' | 'createdDate' | 'destinationBranch' | 'destinationCommit' | 'executionProgress' | 'finishedDate' | 'isPullRequestBuild' | 'issueCounts' | 'number' | 'product' | 'pullRequest' | 'sourceBranchOrTag' | 'sourceCommit' | 'startReason' | 'startedDate' | 'workflow'>;
        fieldsCiTestResults?: Array<'className' | 'destinationTestResults' | 'fileSource' | 'message' | 'name' | 'status'>;
        fieldsCiArtifacts?: Array<'downloadUrl' | 'fileName' | 'fileSize' | 'fileType'>;
        options: {
            headers: {
                [name: string]: string;
        ...
        const { id, fieldsCiBuildActions, include, fieldsCiIssues, fieldsCiBuildRuns, fieldsCiTestResults, fieldsCiArtifacts, options } = params;
        const localVarPath = this.basePath + '/v1/ciBuildActions/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling ciBuildActionsGetInstance.');
        }
        ...
        if (fieldsCiIssues !== undefined) {
            localVarQueryParameters['fields[ciIssues]'] = ObjectSerializer.serialize(fieldsCiIssues, "Array<'category' | 'fileSource' | 'issueType' | 'message'>");
        }
        if (fieldsCiBuildRuns !== undefined) {
            localVarQueryParameters['fields[ciBuildRuns]'] = ObjectSerializer.serialize(fieldsCiBuildRuns, "Array<'actions' | 'buildRun' | 'builds' | 'cancelReason' | 'clean' | 'completionStatus' | 'createdDate' | 'destinationBranch' | 'destinationCommit' | 'executionProgress' | 'finishedDate' | 'isPullRequestBuild' | 'issueCounts' | 'number' | 'product' | 'pullRequest' | 'sourceBranchOrTag' | 'sourceCommit' | 'startReason' | 'startedDate' | 'workflow'>");
        }
        if (fieldsCiTestResults !== undefined) {
            localVarQueryParameters['fields[ciTestResults]'] = ObjectSerializer.serialize(fieldsCiTestResults, "Array<'className' | 'destinationTestResults' | 'fileSource' | 'message' | 'name' | 'status'>");
        }
        if (fieldsCiArtifacts !== undefined) {
            localVarQueryParameters['fields[ciArtifacts]'] = ObjectSerializer.serialize(fieldsCiArtifacts, "Array<'downloadUrl' | 'fileName' | 'fileSize' | 'fileType'>");
        }
            ...
            return new Promise<{
                ...
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "CiBuildActionResponse");
                            resolve({ response: response, body: body });
                        }
                        else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param limit maximum resources per page
     */
    public async ciBuildActionsIssuesGetToManyRelated(params: {
        id: string;
        fieldsCiIssues?: Array<'category' | 'fileSource' | 'issueType' | 'message'>;
        limit?: number;
        options: {
        ...
        const { id, fieldsCiIssues, limit, options } = params;
        const localVarPath = this.basePath + '/v1/ciBuildActions/{id}/issues'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling ciBuildActionsIssuesGetToManyRelated.');
        }
        if (fieldsCiIssues !== undefined) {
            localVarQueryParameters['fields[ciIssues]'] = ObjectSerializer.serialize(fieldsCiIssues, "Array<'category' | 'fileSource' | 'issueType' | 'message'>");
        }
     ...
     * @param limit maximum resources per page
     */
    public async ciBuildActionsTestResultsGetToManyRelated(params: {
        id: string;
        fieldsCiTestResults?: Array<'className' | 'destinationTestResults' | 'fileSource' | 'message' | 'name' | 'status'>;
        limit?: number;
        options: {
        ...
        const { id, fieldsCiTestResults, limit, options } = params;
        const localVarPath = this.basePath + '/v1/ciBuildActions/{id}/testResults'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling ciBuildActionsTestResultsGetToManyRelated.');
        }
        if (fieldsCiTestResults !== undefined) {
            localVarQueryParameters['fields[ciTestResults]'] = ObjectSerializer.serialize(fieldsCiTestResults, "Array<'className' | 'destinationTestResults' | 'fileSource' | 'message' | 'name' | 'status'>");
        }
            ...
            return new Promise<{
                ...
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "CiTestResultsResponse");
                            resolve({ response: response, body: body });
                        }
                        else {
                            reject(new HttpError(response, body, response.statusCode));
