...
export class CiBuildRunsApi {
     ...
     */
    public async ciBuildRunsActionsGetToManyRelated(params: {
        id: string;
        ...
        fieldsCiBuildActions?: Array<'actionType' | 'artifacts' | 'buildRun' | 'completionStatus' | 'executionProgress' | 'finishedDate' | 'isRequiredToPass' | 'issueCounts' | 'issues' | 'name' | 'startedDate' | 'testResults'>;
        limit?: number;
        ...
        const { id, fieldsCiBuildRuns, fieldsCiBuildActions, limit, include, options } = params;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async ciBuildRunsBuildsGetToManyRelated(params: {
        id: string;
     ...
     */
    public async ciBuildRunsCreateInstance(params: {
        ...
        const { ciBuildRunCreateRequest, options } = params;
     ...
     */
    public async ciBuildRunsGetInstance(params: {
        id: string;
        fieldsCiBuildRuns?: Array<'actions' | 'buildRun' | 'builds' | 'cancelReason' | 'clean' | 'completionStatus' | 'createdDate' | 'destinationBranch' | 'destinationCommit' | 'executionProgress' | 'finishedDate' | 'isPullRequestBuild' | 'issueCounts' | 'number' | 'product' | 'pullRequest' | 'sourceBranchOrTag' | 'sourceCommit' | 'startReason' | 'startedDate' | 'workflow'>;
        ...
        const { id, fieldsCiBuildRuns, include, fieldsCiBuildActions, fieldsBuilds, limitBuilds, options } = params;
