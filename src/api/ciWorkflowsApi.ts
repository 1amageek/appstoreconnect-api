...
export class CiWorkflowsApi {
     ...
     */
    public async ciWorkflowsBuildRunsGetToManyRelated(params: {
        id: string;
     ...
     */
    public async ciWorkflowsCreateInstance(params: {
        ...
        const { ciWorkflowCreateRequest, options } = params;
     ...
     * @param id the id of the requested resource
     */
    public async ciWorkflowsDeleteInstance(params: {
        id: string;
        options: {
            headers: {
                [name: string]: string;
     ...
     */
    public async ciWorkflowsGetInstance(params: {
        id: string;
        fieldsCiWorkflows?: Array<'actions' | 'branchStartCondition' | 'buildRuns' | 'clean' | 'containerFilePath' | 'description' | 'isEnabled' | 'isLockedForEditing' | 'lastModifiedDate' | 'macOsVersion' | 'name' | 'product' | 'pullRequestStartCondition' | 'repository' | 'scheduledStartCondition' | 'tagStartCondition' | 'xcodeVersion'>;
        ...
        const { id, fieldsCiWorkflows, include, fieldsCiBuildRuns, fieldsScmRepositories, options } = params;
        const localVarPath = this.basePath + '/v1/ciWorkflows/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param include comma-separated list of relationships to include
     */
    public async ciWorkflowsRepositoryGetToOneRelated(params: {
        id: string;
        fieldsScmGitReferences?: Array<'canonicalName' | 'isDeleted' | 'kind' | 'name' | 'repository'>;
        ...
        const { id, fieldsScmGitReferences, fieldsScmProviders, fieldsScmRepositories, include, options } = params;
     ...
     */
    public async ciWorkflowsUpdateInstance(params: {
        id: string;
        ...
        const { id, ciWorkflowUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/ciWorkflows/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
