...
export class DevicesApi {
     ...
     */
    public async devicesCreateInstance(params: {
        ...
        const { deviceCreateRequest, options } = params;
     ...
     */
    public async devicesGetCollection(params: {
        filterName?: Array<string>;
        filterPlatform?: Array<'IOS' | 'MAC_OS'>;
        filterStatus?: Array<'ENABLED' | 'DISABLED'>;
        filterUdid?: Array<string>;
        filterId?: Array<string>;
        sort?: Array<'id' | '-id' | 'name' | '-name' | 'platform' | '-platform' | 'status' | '-status' | 'udid' | '-udid'>;
        fieldsDevices?: Array<'addedDate' | 'deviceClass' | 'model' | 'name' | 'platform' | 'status' | 'udid'>;
        limit?: number;
        options: {
            headers: {
                [name: string]: string;
        ...
        const { filterName, filterPlatform, filterStatus, filterUdid, filterId, sort, fieldsDevices, limit, options } = params;
        const localVarPath = this.basePath + '/v1/devices';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param fieldsDevices the fields to include for returned resources of type devices
     */
    public async devicesGetInstance(params: {
        id: string;
        fieldsDevices?: Array<'addedDate' | 'deviceClass' | 'model' | 'name' | 'platform' | 'status' | 'udid'>;
        options: {
            headers: {
        ...
        const { id, fieldsDevices, options } = params;
     ...
     */
    public async devicesUpdateInstance(params: {
        id: string;
        ...
        const { id, deviceUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/devices/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
