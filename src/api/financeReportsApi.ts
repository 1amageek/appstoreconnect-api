...
export class FinanceReportsApi {
     ...
     */
    public async financeReportsGetCollection(params: {
        ...
        const { filterRegionCode, filterReportDate, filterReportType, filterVendorNumber, options } = params;
