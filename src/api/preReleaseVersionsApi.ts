...
export class PreReleaseVersionsApi {
    ...
    public setApiKey(params: {
        key: PreReleaseVersionsApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async preReleaseVersionsAppGetToOneRelated(params: {
        id: string;
     ...
     */
    public async preReleaseVersionsBuildsGetToManyRelated(params: {
        id: string;
     ...
     */
    public async preReleaseVersionsGetCollection(params: {
        ...
        const { filterBuildsExpired, filterBuildsProcessingState, filterBuildsVersion, filterPlatform, filterVersion, filterApp, filterBuilds, sort, fieldsPreReleaseVersions, limit, include, fieldsApps, fieldsBuilds, limitBuilds, options } = params;
     ...
     * @param limitBuilds maximum number of related builds returned (when they are included)
     */
    public async preReleaseVersionsGetInstance(params: {
        id: string;
        fieldsPreReleaseVersions?: Array<'app' | 'builds' | 'platform' | 'version'>;
        include?: Array<'app' | 'builds'>;
        fieldsApps?: Array<'appAvailability' | 'appClips' | 'appCustomProductPages' | 'appEvents' | 'appInfos' | 'appPricePoints' | 'appPriceSchedule' | 'appStoreVersions' | 'availableInNewTerritories' | 'availableTerritories' | 'betaAppLocalizations' | 'betaAppReviewDetail' | 'betaGroups' | 'betaLicenseAgreement' | 'betaTesters' | 'builds' | 'bundleId' | 'ciProduct' | 'contentRightsDeclaration' | 'customerReviews' | 'endUserLicenseAgreement' | 'gameCenterEnabledVersions' | 'inAppPurchases' | 'inAppPurchasesV2' | 'isOrEverWasMadeForKids' | 'name' | 'perfPowerMetrics' | 'preOrder' | 'preReleaseVersions' | 'pricePoints' | 'prices' | 'primaryLocale' | 'promotedPurchases' | 'reviewSubmissions' | 'sku' | 'subscriptionGracePeriod' | 'subscriptionGroups' | 'subscriptionStatusUrl' | 'subscriptionStatusUrlForSandbox' | 'subscriptionStatusUrlVersion' | 'subscriptionStatusUrlVersionForSandbox'>;
        ...
        const { id, fieldsPreReleaseVersions, include, fieldsApps, fieldsBuilds, limitBuilds, options } = params;
