...
export class ProfilesApi {
     ...
     */
    public async profilesBundleIdGetToOneRelated(params: {
        id: string;
        ...
        const { id, fieldsBundleIds, options } = params;
     ...
     */
    public async profilesCertificatesGetToManyRelated(params: {
        id: string;
        ...
        const { id, fieldsCertificates, limit, options } = params;
     ...
     */
    public async profilesCreateInstance(params: {
        ...
        const { profileCreateRequest, options } = params;
     ...
     * @param id the id of the requested resource
     */
    public async profilesDeleteInstance(params: {
        id: string;
        options: {
            headers: {
                [name: string]: string;
     ...
     * @param limit maximum resources per page
     */
    public async profilesDevicesGetToManyRelated(params: {
        id: string;
        ...
        const { id, fieldsDevices, limit, options } = params;
     ...
     */
    public async profilesGetCollection(params: {
        ...
        sort?: Array<'id' | '-id' | 'name' | '-name' | 'profileState' | '-profileState' | 'profileType' | '-profileType'>;
        ...
        const { filterName, filterProfileState, filterProfileType, filterId, sort, fieldsProfiles, limit, include, fieldsCertificates, fieldsDevices, fieldsBundleIds, limitCertificates, limitDevices, options } = params;
        const localVarPath = this.basePath + '/v1/profiles';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param limitDevices maximum number of related devices returned (when they are included)
     */
    public async profilesGetInstance(params: {
        id: string;
        fieldsProfiles?: Array<'bundleId' | 'certificates' | 'createdDate' | 'devices' | 'expirationDate' | 'name' | 'platform' | 'profileContent' | 'profileState' | 'profileType' | 'uuid'>;
        include?: Array<'bundleId' | 'certificates' | 'devices'>;
        fieldsCertificates?: Array<'certificateContent' | 'certificateType' | 'csrContent' | 'displayName' | 'expirationDate' | 'name' | 'platform' | 'serialNumber'>;
        ...
        const { id, fieldsProfiles, include, fieldsCertificates, fieldsDevices, fieldsBundleIds, limitCertificates, limitDevices, options } = params;
        const localVarPath = this.basePath + '/v1/profiles/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
