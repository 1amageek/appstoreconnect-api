...
export class PromotedPurchasesApi {
    ...
    public setApiKey(params: {
        key: PromotedPurchasesApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async promotedPurchasesCreateInstance(params: {
        ...
        const { promotedPurchaseCreateRequest, options } = params;
     ...
     */
    public async promotedPurchasesDeleteInstance(params: {
        id: string;
        options: {
            headers: {
                [name: string]: string;
     ...
     */
    public async promotedPurchasesGetInstance(params: {
        id: string;
        ...
        const { id, fieldsPromotedPurchases, include, fieldsPromotedPurchaseImages, limitPromotionImages, options } = params;
        const localVarPath = this.basePath + '/v1/promotedPurchases/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param include comma-separated list of relationships to include
     */
    public async promotedPurchasesPromotionImagesGetToManyRelated(params: {
        id: string;
        fieldsPromotedPurchases?: Array<'app' | 'enabled' | 'inAppPurchaseV2' | 'promotionImages' | 'state' | 'subscription' | 'visibleForAllUsers'>;
        fieldsPromotedPurchaseImages?: Array<'assetToken' | 'assetType' | 'fileName' | 'fileSize' | 'imageAsset' | 'promotedPurchase' | 'sourceFileChecksum' | 'state' | 'uploadOperations' | 'uploaded'>;
        limit?: number;
        ...
        response: http.IncomingMessage;
        body: PromotedPurchaseImagesResponse;
    }> {
        const { id, fieldsPromotedPurchases, fieldsPromotedPurchaseImages, limit, include, options } = params;
     ...
     */
    public async promotedPurchasesUpdateInstance(params: {
        id: string;
        ...
        const { id, promotedPurchaseUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/promotedPurchases/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
