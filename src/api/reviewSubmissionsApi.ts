...
export class ReviewSubmissionsApi {
    ...
    public setApiKey(params: {
        key: ReviewSubmissionsApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async reviewSubmissionsCreateInstance(params: {
        ...
        const { reviewSubmissionCreateRequest, options } = params;
     ...
     */
    public async reviewSubmissionsGetCollection(params: {
        ...
        const { filterApp, filterPlatform, filterState, fieldsReviewSubmissions, limit, include, fieldsReviewSubmissionItems, limitItems, options } = params;
        const localVarPath = this.basePath + '/v1/reviewSubmissions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param limitItems maximum number of related items returned (when they are included)
     */
    public async reviewSubmissionsGetInstance(params: {
        id: string;
        fieldsReviewSubmissions?: Array<'app' | 'appStoreVersionForReview' | 'canceled' | 'items' | 'platform' | 'state' | 'submitted' | 'submittedDate'>;
        include?: Array<'app' | 'appStoreVersionForReview' | 'items'>;
        fieldsReviewSubmissionItems?: Array<'appCustomProductPageVersion' | 'appEvent' | 'appStoreVersion' | 'appStoreVersionExperiment' | 'removed' | 'resolved' | 'reviewSubmission' | 'state'>;
        ...
        const { id, fieldsReviewSubmissions, include, fieldsReviewSubmissionItems, limitItems, options } = params;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async reviewSubmissionsItemsGetToManyRelated(params: {
        id: string;
        ...
        limit?: number;
        include?: Array<'appCustomProductPageVersion' | 'appEvent' | 'appStoreVersion' | 'appStoreVersionExperiment'>;
        options: {
            headers: {
                [name: string]: string;
            };
        ...
        const { id, fieldsAppStoreVersionExperiments, fieldsReviewSubmissionItems, fieldsAppStoreVersions, fieldsAppCustomProductPageVersions, fieldsAppEvents, limit, include, options } = params;
     ...
     */
    public async reviewSubmissionsUpdateInstance(params: {
        id: string;
        ...
        const { id, reviewSubmissionUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/reviewSubmissions/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
