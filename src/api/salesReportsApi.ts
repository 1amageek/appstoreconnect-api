...
export class SalesReportsApi {
     ...
     */
    public async salesReportsGetCollection(params: {
        filterFrequency: Array<'DAILY' | 'WEEKLY' | 'MONTHLY' | 'YEARLY'>;
        filterReportSubType: Array<'SUMMARY' | 'DETAILED'>;
        filterReportType: Array<'SALES' | 'PRE_ORDER' | 'NEWSSTAND' | 'SUBSCRIPTION' | 'SUBSCRIPTION_EVENT' | 'SUBSCRIBER' | 'SUBSCRIPTION_OFFER_CODE_REDEMPTION'>;
        ...
        const { filterFrequency, filterReportSubType, filterReportType, filterVendorNumber, filterReportDate, filterVersion, options } = params;
