...
export class SalesReportsApi {
     ...
     */
    public async salesReportsGetCollection (filterFrequency: Array<'DAILY' | 'WEEKLY' | 'MONTHLY' | 'YEARLY'>, filterReportSubType: Array<'SUMMARY' | 'DETAILED'>, filterReportType: Array<'SALES' | 'PRE_ORDER' | 'NEWSSTAND' | 'SUBSCRIPTION' | 'SUBSCRIPTION_EVENT' | 'SUBSCRIBER' | 'SUBSCRIPTION_OFFER_CODE_REDEMPTION'>, filterVendorNumber: Array<string>, filterReportDate?: Array<string>, filterVersion?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
        ...
        if (filterFrequency === null || filterFrequency === undefined) {
            throw new Error('Required parameter filterFrequency was null or undefined when calling salesReportsGetCollection.');
        }
        ...
        if (filterReportSubType === null || filterReportSubType === undefined) {
            throw new Error('Required parameter filterReportSubType was null or undefined when calling salesReportsGetCollection.');
        }

        // verify required parameter 'filterReportType' is not null or undefined
        if (filterReportType === null || filterReportType === undefined) {
            throw new Error('Required parameter filterReportType was null or undefined when calling salesReportsGetCollection.');
        }
        ...
        if (filterVendorNumber === null || filterVendorNumber === undefined) {
            throw new Error('Required parameter filterVendorNumber was null or undefined when calling salesReportsGetCollection.');
        }

        if (filterFrequency !== undefined) {
            localVarQueryParameters['filter[frequency]'] = ObjectSerializer.serialize(filterFrequency, "Array<'DAILY' | 'WEEKLY' | 'MONTHLY' | 'YEARLY'>");
        }

        if (filterReportDate !== undefined) {
            localVarQueryParameters['filter[reportDate]'] = ObjectSerializer.serialize(filterReportDate, "Array<string>");
        }

        if (filterReportSubType !== undefined) {
            localVarQueryParameters['filter[reportSubType]'] = ObjectSerializer.serialize(filterReportSubType, "Array<'SUMMARY' | 'DETAILED'>");
        }

        if (filterReportType !== undefined) {
            localVarQueryParameters['filter[reportType]'] = ObjectSerializer.serialize(filterReportType, "Array<'SALES' | 'PRE_ORDER' | 'NEWSSTAND' | 'SUBSCRIPTION' | 'SUBSCRIPTION_EVENT' | 'SUBSCRIBER' | 'SUBSCRIPTION_OFFER_CODE_REDEMPTION'>");
        }

        if (filterVendorNumber !== undefined) {
            localVarQueryParameters['filter[vendorNumber]'] = ObjectSerializer.serialize(filterVendorNumber, "Array<string>");
        }
