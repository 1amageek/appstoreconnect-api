...
export class ScmProvidersApi {
     ...
     */
    public async scmProvidersGetCollection(params: {
        ...
        const { fieldsScmProviders, limit, fieldsScmRepositories, options } = params;
     ...
     * @param fieldsScmRepositories the fields to include for returned resources of type scmRepositories
     */
    public async scmProvidersGetInstance(params: {
        id: string;
        fieldsScmProviders?: Array<'repositories' | 'scmProviderType' | 'url'>;
        fieldsScmRepositories?: Array<'defaultBranch' | 'gitReferences' | 'httpCloneUrl' | 'lastAccessedDate' | 'ownerName' | 'pullRequests' | 'repositoryName' | 'scmProvider' | 'sshCloneUrl'>;
        options: {
        ...
        const { id, fieldsScmProviders, fieldsScmRepositories, options } = params;
     ...
     */
    public async scmProvidersRepositoriesGetToManyRelated(params: {
        id: string;
