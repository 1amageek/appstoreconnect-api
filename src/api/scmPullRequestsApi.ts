...
export class ScmPullRequestsApi {
     ...
     */
    public async scmPullRequestsGetInstance(params: {
        id: string;
        ...
        body: ScmPullRequestResponse;
    }> {
        const { id, fieldsScmPullRequests, include, options } = params;
