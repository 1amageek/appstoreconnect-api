...
export class ScmRepositoriesApi {
     ...
     */
    public async scmRepositoriesGetCollection(params: {
        ...
        const { filterId, fieldsScmRepositories, limit, include, fieldsScmGitReferences, fieldsScmPullRequests, options } = params;
     ...
     * @param fieldsScmPullRequests the fields to include for returned resources of type scmPullRequests
     */
    public async scmRepositoriesGetInstance(params: {
        id: string;
        fieldsScmRepositories?: Array<'defaultBranch' | 'gitReferences' | 'httpCloneUrl' | 'lastAccessedDate' | 'ownerName' | 'pullRequests' | 'repositoryName' | 'scmProvider' | 'sshCloneUrl'>;
        include?: Array<'defaultBranch' | 'scmProvider'>;
        fieldsScmGitReferences?: Array<'canonicalName' | 'isDeleted' | 'kind' | 'name' | 'repository'>;
        ...
        const { id, fieldsScmRepositories, include, fieldsScmGitReferences, fieldsScmPullRequests, options } = params;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async scmRepositoriesGitReferencesGetToManyRelated(params: {
        id: string;
        fieldsScmGitReferences?: Array<'canonicalName' | 'isDeleted' | 'kind' | 'name' | 'repository'>;
        fieldsScmRepositories?: Array<'defaultBranch' | 'gitReferences' | 'httpCloneUrl' | 'lastAccessedDate' | 'ownerName' | 'pullRequests' | 'repositoryName' | 'scmProvider' | 'sshCloneUrl'>;
        limit?: number;
        ...
        const { id, fieldsScmGitReferences, fieldsScmRepositories, limit, include, options } = params;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async scmRepositoriesPullRequestsGetToManyRelated(params: {
        id: string;
        fieldsScmPullRequests?: Array<'destinationBranchName' | 'destinationRepositoryName' | 'destinationRepositoryOwner' | 'isClosed' | 'isCrossRepository' | 'number' | 'repository' | 'sourceBranchName' | 'sourceRepositoryName' | 'sourceRepositoryOwner' | 'title' | 'webUrl'>;
        fieldsScmRepositories?: Array<'defaultBranch' | 'gitReferences' | 'httpCloneUrl' | 'lastAccessedDate' | 'ownerName' | 'pullRequests' | 'repositoryName' | 'scmProvider' | 'sshCloneUrl'>;
        limit?: number;
        ...
        const { id, fieldsScmPullRequests, fieldsScmRepositories, limit, include, options } = params;
