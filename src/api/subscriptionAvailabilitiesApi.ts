...
export class SubscriptionAvailabilitiesApi {
    ...
    public setApiKey(params: {
        key: SubscriptionAvailabilitiesApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async subscriptionAvailabilitiesAvailableTerritoriesGetToManyRelated(params: {
        id: string;
     ...
     */
    public async subscriptionAvailabilitiesCreateInstance(params: {
        ...
        response: http.IncomingMessage;
        body: SubscriptionAvailabilityResponse;
    }> {
        const { subscriptionAvailabilityCreateRequest, options } = params;
     ...
     */
    public async subscriptionAvailabilitiesGetInstance(params: {
        id: string;
        fieldsSubscriptionAvailabilities?: Array<'availableInNewTerritories' | 'availableTerritories' | 'subscription'>;
        include?: Array<'availableTerritories' | 'subscription'>;
        fieldsTerritories?: Array<'currency'>;
        ...
        const { id, fieldsSubscriptionAvailabilities, include, fieldsTerritories, limitAvailableTerritories, options } = params;
