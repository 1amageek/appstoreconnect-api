...
export class SubscriptionOfferCodesApi {
    ...
    public setApiKey(params: {
        key: SubscriptionOfferCodesApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async subscriptionOfferCodesCreateInstance(params: {
        ...
        body: SubscriptionOfferCodeResponse;
    }> {
        const { subscriptionOfferCodeCreateRequest, options } = params;
     ...
     */
    public async subscriptionOfferCodesCustomCodesGetToManyRelated(params: {
        id: string;
        ...
        response: http.IncomingMessage;
        body: SubscriptionOfferCodeCustomCodesResponse;
    }> {
        const { id, fieldsSubscriptionOfferCodeCustomCodes, fieldsSubscriptionOfferCodes, limit, include, options } = params;
     ...
     */
    public async subscriptionOfferCodesGetInstance(params: {
        id: string;
        fieldsSubscriptionOfferCodes?: Array<'active' | 'customCodes' | 'customerEligibilities' | 'duration' | 'name' | 'numberOfPeriods' | 'offerEligibility' | 'offerMode' | 'oneTimeUseCodes' | 'prices' | 'subscription' | 'totalNumberOfCodes'>;
        ...
        const { id, fieldsSubscriptionOfferCodes, include, fieldsSubscriptionOfferCodeCustomCodes, fieldsSubscriptionOfferCodeOneTimeUseCodes, fieldsSubscriptionOfferCodePrices, limitCustomCodes, limitOneTimeUseCodes, limitPrices, options } = params;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async subscriptionOfferCodesOneTimeUseCodesGetToManyRelated(params: {
        id: string;
        fieldsSubscriptionOfferCodes?: Array<'active' | 'customCodes' | 'customerEligibilities' | 'duration' | 'name' | 'numberOfPeriods' | 'offerEligibility' | 'offerMode' | 'oneTimeUseCodes' | 'prices' | 'subscription' | 'totalNumberOfCodes'>;
        fieldsSubscriptionOfferCodeOneTimeUseCodes?: Array<'active' | 'createdDate' | 'expirationDate' | 'numberOfCodes' | 'offerCode' | 'values'>;
        limit?: number;
        ...
        response: http.IncomingMessage;
        body: SubscriptionOfferCodeOneTimeUseCodesResponse;
    }> {
        const { id, fieldsSubscriptionOfferCodes, fieldsSubscriptionOfferCodeOneTimeUseCodes, limit, include, options } = params;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async subscriptionOfferCodesPricesGetToManyRelated(params: {
        id: string;
        ...
        response: http.IncomingMessage;
        body: SubscriptionOfferCodePricesResponse;
    }> {
        const { id, filterTerritory, fieldsSubscriptionPricePoints, fieldsTerritories, fieldsSubscriptionOfferCodePrices, limit, include, options } = params;
     ...
     */
    public async subscriptionOfferCodesUpdateInstance(params: {
        id: string;
        ...
        const { id, subscriptionOfferCodeUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/subscriptionOfferCodes/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
