...
export class SubscriptionPricePointsApi {
    ...
    public setApiKey(params: {
        key: SubscriptionPricePointsApiApiKeys;
        value: string;
    }) {
     ...
     */
    public async subscriptionPricePointsEqualizationsGetToManyRelated(params: {
        id: string;
        ...
        const { id, filterSubscription, filterTerritory, fieldsSubscriptionPricePoints, fieldsTerritories, limit, include, options } = params;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async subscriptionPricePointsGetInstance(params: {
        id: string;
        fieldsSubscriptionPricePoints?: Array<'customerPrice' | 'equalizations' | 'proceeds' | 'proceedsYear2' | 'subscription' | 'territory'>;
        include?: Array<'territory'>;
        options: {
        ...
        response: http.IncomingMessage;
        body: SubscriptionPricePointResponse;
    }> {
        const { id, fieldsSubscriptionPricePoints, include, options } = params;
