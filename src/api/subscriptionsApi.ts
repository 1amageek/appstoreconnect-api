...
export class SubscriptionsApi {
     ...
     */
    public async subscriptionsAppStoreReviewScreenshotGetToOneRelated(params: {
        id: string;
        ...
        body: SubscriptionAppStoreReviewScreenshotResponse;
    }> {
        const { id, fieldsSubscriptionAppStoreReviewScreenshots, fieldsSubscriptions, include, options } = params;
     ...
     */
    public async subscriptionsCreateInstance(params: {
        ...
        const { subscriptionCreateRequest, options } = params;
     ...
     * @param id the id of the requested resource
     */
    public async subscriptionsDeleteInstance(params: {
        id: string;
        options: {
            headers: {
                [name: string]: string;
     ...
     */
    public async subscriptionsGetInstance(params: {
        id: string;
        fieldsSubscriptions?: Array<'appStoreReviewScreenshot' | 'availableInAllTerritories' | 'familySharable' | 'group' | 'groupLevel' | 'introductoryOffers' | 'name' | 'offerCodes' | 'pricePoints' | 'prices' | 'productId' | 'promotedPurchase' | 'promotionalOffers' | 'reviewNote' | 'state' | 'subscriptionLocalizations' | 'subscriptionPeriod'>;
        ...
        const { id, fieldsSubscriptions, include, fieldsPromotedPurchases, fieldsSubscriptionPricePoints, fieldsSubscriptionPromotionalOffers, fieldsSubscriptionOfferCodes, fieldsSubscriptionAppStoreReviewScreenshots, fieldsSubscriptionPrices, fieldsSubscriptionIntroductoryOffers, fieldsSubscriptionLocalizations, limitIntroductoryOffers, limitOfferCodes, limitPrices, limitPromotionalOffers, limitSubscriptionLocalizations, options } = params;
        const localVarPath = this.basePath + '/v1/subscriptions/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async subscriptionsIntroductoryOffersDeleteToManyRelationship(params: {
        id: string;
        ...
        const { id, subscriptionIntroductoryOffersLinkagesRequest, options } = params;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async subscriptionsIntroductoryOffersGetToManyRelated(params: {
        id: string;
        ...
        limit?: number;
        include?: Array<'subscription' | 'subscriptionPricePoint' | 'territory'>;
        options: {
            headers: {
                [name: string]: string;
            };
        ...
        response: http.IncomingMessage;
        body: SubscriptionIntroductoryOffersResponse;
    }> {
        const { id, filterTerritory, fieldsSubscriptionPricePoints, fieldsSubscriptions, fieldsSubscriptionIntroductoryOffers, fieldsTerritories, limit, include, options } = params;
     ...
     * @param limit maximum resources per page
     */
    public async subscriptionsIntroductoryOffersGetToManyRelationship(params: {
        id: string;
        limit?: number;
        options: {
            headers: {
        ...
        response: http.IncomingMessage;
        body: SubscriptionIntroductoryOffersLinkagesResponse;
    }> {
     ...
     * @param include comma-separated list of relationships to include
     */
    public async subscriptionsOfferCodesGetToManyRelated(params: {
        id: string;
        filterTerritory?: Array<string>;
        fieldsSubscriptionOfferCodeCustomCodes?: Array<'active' | 'createdDate' | 'customCode' | 'expirationDate' | 'numberOfCodes' | 'offerCode'>;
        fieldsSubscriptionOfferCodes?: Array<'active' | 'customCodes' | 'customerEligibilities' | 'duration' | 'name' | 'numberOfPeriods' | 'offerEligibility' | 'offerMode' | 'oneTimeUseCodes' | 'prices' | 'subscription' | 'totalNumberOfCodes'>;
        fieldsSubscriptionOfferCodeOneTimeUseCodes?: Array<'active' | 'createdDate' | 'expirationDate' | 'numberOfCodes' | 'offerCode' | 'values'>;
        fieldsSubscriptions?: Array<'appStoreReviewScreenshot' | 'availableInAllTerritories' | 'familySharable' | 'group' | 'groupLevel' | 'introductoryOffers' | 'name' | 'offerCodes' | 'pricePoints' | 'prices' | 'productId' | 'promotedPurchase' | 'promotionalOffers' | 'reviewNote' | 'state' | 'subscriptionLocalizations' | 'subscriptionPeriod'>;
        fieldsSubscriptionOfferCodePrices?: Array<'subscriptionPricePoint' | 'territory'>;
        limit?: number;
        limitOneTimeUseCodes?: number;
        limitCustomCodes?: number;
        limitPrices?: number;
        include?: Array<'customCodes' | 'oneTimeUseCodes' | 'prices' | 'subscription'>;
        options: {
            headers: {
                [name: string]: string;
            };
        ...
        response: http.IncomingMessage;
        body: SubscriptionOfferCodesResponse;
    }> {
        const { id, filterTerritory, fieldsSubscriptionOfferCodeCustomCodes, fieldsSubscriptionOfferCodes, fieldsSubscriptionOfferCodeOneTimeUseCodes, fieldsSubscriptions, fieldsSubscriptionOfferCodePrices, limit, limitOneTimeUseCodes, limitCustomCodes, limitPrices, include, options } = params;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async subscriptionsPricePointsGetToManyRelated(params: {
        id: string;
        filterTerritory?: Array<string>;
        fieldsSubscriptionPricePoints?: Array<'customerPrice' | 'equalizations' | 'proceeds' | 'proceedsYear2' | 'subscription' | 'territory'>;
        fieldsTerritories?: Array<'currency'>;
        ...
        response: http.IncomingMessage;
        body: SubscriptionPricePointsResponse;
    }> {
        const { id, filterTerritory, fieldsSubscriptionPricePoints, fieldsTerritories, limit, include, options } = params;
     ...
     */
    public async subscriptionsPricesDeleteToManyRelationship(params: {
        id: string;
        ...
        const { id, subscriptionPricesLinkagesRequest, options } = params;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async subscriptionsPricesGetToManyRelated(params: {
        id: string;
        ...
        response: http.IncomingMessage;
        body: SubscriptionPricesResponse;
    }> {
        const { id, filterSubscriptionPricePoint, filterTerritory, fieldsSubscriptionPricePoints, fieldsSubscriptionPrices, fieldsTerritories, limit, include, options } = params;
     ...
     * @param limit maximum resources per page
     */
    public async subscriptionsPricesGetToManyRelationship(params: {
        id: string;
        limit?: number;
        options: {
            headers: {
        ...
        response: http.IncomingMessage;
        body: SubscriptionPricesLinkagesResponse;
    }> {
        const { id, limit, options } = params;
        const localVarPath = this.basePath + '/v1/subscriptions/{id}/relationships/prices'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     * @param include comma-separated list of relationships to include
     */
    public async subscriptionsPromotedPurchaseGetToOneRelated(params: {
        id: string;
        fieldsPromotedPurchases?: Array<'app' | 'enabled' | 'inAppPurchaseV2' | 'promotionImages' | 'state' | 'subscription' | 'visibleForAllUsers'>;
        fieldsSubscriptions?: Array<'appStoreReviewScreenshot' | 'availableInAllTerritories' | 'familySharable' | 'group' | 'groupLevel' | 'introductoryOffers' | 'name' | 'offerCodes' | 'pricePoints' | 'prices' | 'productId' | 'promotedPurchase' | 'promotionalOffers' | 'reviewNote' | 'state' | 'subscriptionLocalizations' | 'subscriptionPeriod'>;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async subscriptionsPromotionalOffersGetToManyRelated(params: {
        id: string;
        filterTerritory?: Array<string>;
        fieldsSubscriptionPromotionalOffers?: Array<'duration' | 'name' | 'numberOfPeriods' | 'offerCode' | 'offerMode' | 'prices' | 'subscription'>;
        fieldsSubscriptions?: Array<'appStoreReviewScreenshot' | 'availableInAllTerritories' | 'familySharable' | 'group' | 'groupLevel' | 'introductoryOffers' | 'name' | 'offerCodes' | 'pricePoints' | 'prices' | 'productId' | 'promotedPurchase' | 'promotionalOffers' | 'reviewNote' | 'state' | 'subscriptionLocalizations' | 'subscriptionPeriod'>;
        ...
        response: http.IncomingMessage;
        body: SubscriptionPromotionalOffersResponse;
    }> {
        const { id, filterTerritory, fieldsSubscriptionPromotionalOffers, fieldsSubscriptions, fieldsSubscriptionPromotionalOfferPrices, limit, limitPrices, include, options } = params;
     ...
     * @param include comma-separated list of relationships to include
     */
    public async subscriptionsSubscriptionLocalizationsGetToManyRelated(params: {
        id: string;
        fieldsSubscriptions?: Array<'appStoreReviewScreenshot' | 'availableInAllTerritories' | 'familySharable' | 'group' | 'groupLevel' | 'introductoryOffers' | 'name' | 'offerCodes' | 'pricePoints' | 'prices' | 'productId' | 'promotedPurchase' | 'promotionalOffers' | 'reviewNote' | 'state' | 'subscriptionLocalizations' | 'subscriptionPeriod'>;
        fieldsSubscriptionLocalizations?: Array<'description' | 'locale' | 'name' | 'state' | 'subscription'>;
        limit?: number;
        ...
        response: http.IncomingMessage;
        body: SubscriptionLocalizationsResponse;
    }> {
        const { id, fieldsSubscriptions, fieldsSubscriptionLocalizations, limit, include, options } = params;
     ...
     */
    public async subscriptionsUpdateInstance(params: {
        id: string;
        ...
        const { id, subscriptionUpdateRequest, options } = params;
        const localVarPath = this.basePath + '/v1/subscriptions/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
