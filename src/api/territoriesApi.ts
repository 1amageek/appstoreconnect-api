...
export enum TerritoriesApiApiKeys {
}
...
export class TerritoriesApi {
    ...
    public setApiKey(key: TerritoriesApiApiKeys, value: string) {
        (this.authentications as any)[TerritoriesApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async territoriesGetCollection (fieldsTerritories?: Array<'currency'>, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TerritoriesResponse;  }> {
        const localVarPath = this.basePath + '/v1/territories';
