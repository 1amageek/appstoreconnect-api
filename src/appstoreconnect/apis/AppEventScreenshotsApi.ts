...
import type { AppEventScreenshotCreateRequest, AppEventScreenshotResponse, AppEventScreenshotUpdateRequest, ErrorResponse, } from '../models';
import { AppEventScreenshotCreateRequestFromJSON, AppEventScreenshotCreateRequestToJSON, AppEventScreenshotResponseFromJSON, AppEventScreenshotResponseToJSON, AppEventScreenshotUpdateRequestFromJSON, AppEventScreenshotUpdateRequestToJSON, ErrorResponseFromJSON, ErrorResponseToJSON, } from '../models';
 ...
 * @export
 */
export type AppEventScreenshotsGetInstanceFieldsAppEventScreenshotsEnum = 'appEventAssetType' | 'appEventLocalization' | 'assetDeliveryState' | 'assetToken' | 'fileName' | 'fileSize' | 'imageAsset' | 'uploadOperations' | 'uploaded';;
/**
 * @export
 */
export type AppEventScreenshotsGetInstanceIncludeEnum = 'appEventLocalization';;
