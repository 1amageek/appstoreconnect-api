...
import type { AppInfoLocalizationCreateRequest, AppInfoLocalizationResponse, AppInfoLocalizationUpdateRequest, ErrorResponse, } from '../models';
import { AppInfoLocalizationCreateRequestFromJSON, AppInfoLocalizationCreateRequestToJSON, AppInfoLocalizationResponseFromJSON, AppInfoLocalizationResponseToJSON, AppInfoLocalizationUpdateRequestFromJSON, AppInfoLocalizationUpdateRequestToJSON, ErrorResponseFromJSON, ErrorResponseToJSON, } from '../models';
 ...
 * @export
 */
export type AppInfoLocalizationsGetInstanceFieldsAppInfoLocalizationsEnum = 'appInfo' | 'locale' | 'name' | 'privacyChoicesUrl' | 'privacyPolicyText' | 'privacyPolicyUrl' | 'subtitle';;
/**
 * @export
 */
export type AppInfoLocalizationsGetInstanceIncludeEnum = 'appInfo';;
