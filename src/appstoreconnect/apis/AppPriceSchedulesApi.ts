...
import type { AppPriceScheduleCreateRequest, AppPriceScheduleResponse, AppPricesV2Response, ErrorResponse, TerritoryResponse, } from '../models';
import { AppPriceScheduleCreateRequestFromJSON, AppPriceScheduleCreateRequestToJSON, AppPriceScheduleResponseFromJSON, AppPriceScheduleResponseToJSON, AppPricesV2ResponseFromJSON, AppPricesV2ResponseToJSON, ErrorResponseFromJSON, ErrorResponseToJSON, TerritoryResponseFromJSON, TerritoryResponseToJSON, } from '../models';
 ...
 * @export
 */
export type AppPriceSchedulesAutomaticPricesGetToManyRelatedFieldsAppPricesEnum = 'appPricePoint' | 'endDate' | 'manual' | 'startDate' | 'territory';;
/**
 * @export
 */
export type AppPriceSchedulesAutomaticPricesGetToManyRelatedFieldsAppPricePointsEnum = 'app' | 'customerPrice' | 'equalizations' | 'proceeds' | 'territory';;
/**
 * @export
 */
export type AppPriceSchedulesAutomaticPricesGetToManyRelatedFieldsTerritoriesEnum = 'currency';;
/**
 * @export
 */
export type AppPriceSchedulesAutomaticPricesGetToManyRelatedIncludeEnum = 'appPricePoint' | 'territory';;
/**
 * @export
 */
export type AppPriceSchedulesBaseTerritoryGetToOneRelatedFieldsTerritoriesEnum = 'currency';;
/**
 * @export
 */
export type AppPriceSchedulesGetInstanceFieldsAppPriceSchedulesEnum = 'app' | 'automaticPrices' | 'baseTerritory' | 'manualPrices';;
/**
 * @export
 */
export type AppPriceSchedulesGetInstanceIncludeEnum = 'app' | 'automaticPrices' | 'baseTerritory' | 'manualPrices';;
/**
 * @export
 */
export type AppPriceSchedulesGetInstanceFieldsAppPricesEnum = 'appPricePoint' | 'endDate' | 'manual' | 'startDate' | 'territory';;
/**
 * @export
 */
export type AppPriceSchedulesGetInstanceFieldsTerritoriesEnum = 'currency';;
/**
 * @export
 */
export type AppPriceSchedulesManualPricesGetToManyRelatedFieldsAppPricesEnum = 'appPricePoint' | 'endDate' | 'manual' | 'startDate' | 'territory';;
/**
 * @export
 */
export type AppPriceSchedulesManualPricesGetToManyRelatedFieldsAppPricePointsEnum = 'app' | 'customerPrice' | 'equalizations' | 'proceeds' | 'territory';;
/**
 * @export
 */
export type AppPriceSchedulesManualPricesGetToManyRelatedFieldsTerritoriesEnum = 'currency';;
/**
 * @export
 */
export type AppPriceSchedulesManualPricesGetToManyRelatedIncludeEnum = 'appPricePoint' | 'territory';;
