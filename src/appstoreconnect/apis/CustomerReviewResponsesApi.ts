...
import type { CustomerReviewResponseV1CreateRequest, CustomerReviewResponseV1Response, ErrorResponse, } from '../models';
import { CustomerReviewResponseV1CreateRequestFromJSON, CustomerReviewResponseV1CreateRequestToJSON, CustomerReviewResponseV1ResponseFromJSON, CustomerReviewResponseV1ResponseToJSON, ErrorResponseFromJSON, ErrorResponseToJSON, } from '../models';
 ...
 * @export
 */
export type CustomerReviewResponsesGetInstanceFieldsCustomerReviewResponsesEnum = 'lastModifiedDate' | 'responseBody' | 'review' | 'state';;
/**
 * @export
 */
export type CustomerReviewResponsesGetInstanceIncludeEnum = 'review';;
