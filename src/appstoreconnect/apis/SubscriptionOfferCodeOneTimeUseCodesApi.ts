...
import type { ErrorResponse, SubscriptionOfferCodeOneTimeUseCodeCreateRequest, SubscriptionOfferCodeOneTimeUseCodeResponse, SubscriptionOfferCodeOneTimeUseCodeUpdateRequest, } from '../models';
import { ErrorResponseFromJSON, ErrorResponseToJSON, SubscriptionOfferCodeOneTimeUseCodeCreateRequestFromJSON, SubscriptionOfferCodeOneTimeUseCodeCreateRequestToJSON, SubscriptionOfferCodeOneTimeUseCodeResponseFromJSON, SubscriptionOfferCodeOneTimeUseCodeResponseToJSON, SubscriptionOfferCodeOneTimeUseCodeUpdateRequestFromJSON, SubscriptionOfferCodeOneTimeUseCodeUpdateRequestToJSON, } from '../models';
