...
import type { RoutingAppCoverageRelationships } from './RoutingAppCoverageRelationships';
import {
    RoutingAppCoverageRelationshipsFromJSON,
    RoutingAppCoverageRelationshipsFromJSONTyped,
    RoutingAppCoverageRelationshipsToJSON,
} from './RoutingAppCoverageRelationships';
...
export function RoutingAppCoverageFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingAppCoverage {
    ...
    return {
        ...
        'relationships': !exists(json, 'relationships') ? undefined : RoutingAppCoverageRelationshipsFromJSON(json['relationships']),
...
export function RoutingAppCoverageToJSON(value?: RoutingAppCoverage | null): any {
    ...
    return {
        ...
        'relationships': RoutingAppCoverageRelationshipsToJSON(value.relationships),
