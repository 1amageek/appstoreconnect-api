...
export class AppClipAdvancedExperienceUpdateRequestDataRelationshipsHeaderImage {
    ...
    static getAttributeTypeMap() {
        return AppClipAdvancedExperienceUpdateRequestDataRelationshipsHeaderImage.attributeTypeMap;
    }
}
