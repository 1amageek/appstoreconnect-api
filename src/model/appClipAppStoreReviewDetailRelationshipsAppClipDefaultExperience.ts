...
export class AppClipAppStoreReviewDetailRelationshipsAppClipDefaultExperience {
    ...
    static getAttributeTypeMap() {
        return AppClipAppStoreReviewDetailRelationshipsAppClipDefaultExperience.attributeTypeMap;
    }
}
