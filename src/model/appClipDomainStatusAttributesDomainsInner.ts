...
export class AppClipDomainStatusAttributesDomainsInner {
    ...
    'errorCode'?: AppClipDomainStatusAttributesDomainsInner.ErrorCodeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "errorCode",
            "baseName": "errorCode",
            "type": "AppClipDomainStatusAttributesDomainsInner.ErrorCodeEnum"
        }    ];
...
export namespace AppClipDomainStatusAttributesDomainsInner {
    export enum ErrorCodeEnum {
        ...
        InvalidEntitlementMissingSection = <any> 'INVALID_ENTITLEMENT_MISSING_SECTION',
        InvalidEntitlementSyntaxError = <any> 'INVALID_ENTITLEMENT_SYNTAX_ERROR',
        InvalidEntitlementUnhandledSection = <any> 'INVALID_ENTITLEMENT_UNHANDLED_SECTION',
