...
export class AppCustomProductPageLocalizationInlineCreateRelationshipsAppCustomProductPageVersion {
    ...
    static getAttributeTypeMap() {
        return AppCustomProductPageLocalizationInlineCreateRelationshipsAppCustomProductPageVersion.attributeTypeMap;
    }
}
