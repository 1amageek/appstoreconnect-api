...
export class AppCustomProductPageLocalizationRelationshipsAppScreenshotSets {
    ...
    static getAttributeTypeMap() {
        return AppCustomProductPageLocalizationRelationshipsAppScreenshotSets.attributeTypeMap;
    }
}
