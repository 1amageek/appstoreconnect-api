...
export class AppCustomProductPageVersionInlineCreateRelationshipsAppCustomProductPage {
    ...
    static getAttributeTypeMap() {
        return AppCustomProductPageVersionInlineCreateRelationshipsAppCustomProductPage.attributeTypeMap;
    }
}
