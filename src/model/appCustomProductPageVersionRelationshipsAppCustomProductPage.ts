...
export class AppCustomProductPageVersionRelationshipsAppCustomProductPage {
    ...
    static getAttributeTypeMap() {
        return AppCustomProductPageVersionRelationshipsAppCustomProductPage.attributeTypeMap;
    }
}
