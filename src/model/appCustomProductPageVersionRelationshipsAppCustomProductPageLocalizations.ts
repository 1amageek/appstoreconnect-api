...
export class AppCustomProductPageVersionRelationshipsAppCustomProductPageLocalizations {
    ...
    static getAttributeTypeMap() {
        return AppCustomProductPageVersionRelationshipsAppCustomProductPageLocalizations.attributeTypeMap;
    }
}
