...
export class AppPreviewSetRelationshipsAppCustomProductPageLocalization {
    ...
    static getAttributeTypeMap() {
        return AppPreviewSetRelationshipsAppCustomProductPageLocalization.attributeTypeMap;
    }
}
