...
import { AppRelationshipsBetaAppReviewDetailData } from './appRelationshipsBetaAppReviewDetailData';

export class AppRelationshipsBetaAppReviewDetail {
    ...
    static getAttributeTypeMap() {
        return AppRelationshipsBetaAppReviewDetail.attributeTypeMap;
    }
}
