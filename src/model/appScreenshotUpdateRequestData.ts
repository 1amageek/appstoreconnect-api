...
export class AppScreenshotUpdateRequestData {
    'type': AppScreenshotUpdateRequestData.TypeEnum;
    'id': string;
    ...
    static getAttributeTypeMap() {
        return AppScreenshotUpdateRequestData.attributeTypeMap;
    }
}

export namespace AppScreenshotUpdateRequestData {
