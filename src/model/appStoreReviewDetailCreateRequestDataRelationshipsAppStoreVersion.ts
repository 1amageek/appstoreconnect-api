...
export class AppStoreReviewDetailCreateRequestDataRelationshipsAppStoreVersion {
    ...
    static getAttributeTypeMap() {
        return AppStoreReviewDetailCreateRequestDataRelationshipsAppStoreVersion.attributeTypeMap;
    }
}
