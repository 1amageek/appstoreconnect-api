...
export class AppStoreVersionExperimentRelationshipsAppStoreVersionExperimentTreatments {
    ...
    static getAttributeTypeMap() {
        return AppStoreVersionExperimentRelationshipsAppStoreVersionExperimentTreatments.attributeTypeMap;
    }
}
