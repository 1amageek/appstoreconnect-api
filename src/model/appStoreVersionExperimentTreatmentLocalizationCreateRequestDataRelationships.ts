...
export class AppStoreVersionExperimentTreatmentLocalizationCreateRequestDataRelationships {
    ...
    static getAttributeTypeMap() {
        return AppStoreVersionExperimentTreatmentLocalizationCreateRequestDataRelationships.attributeTypeMap;
    }
}
