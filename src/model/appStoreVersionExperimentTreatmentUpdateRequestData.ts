...
import { AppStoreVersionExperimentTreatmentUpdateRequestDataAttributes } from './appStoreVersionExperimentTreatmentUpdateRequestDataAttributes';

export class AppStoreVersionExperimentTreatmentUpdateRequestData {
    'type': AppStoreVersionExperimentTreatmentUpdateRequestData.TypeEnum;
    'id': string;
...
export namespace AppStoreVersionExperimentTreatmentUpdateRequestData {
