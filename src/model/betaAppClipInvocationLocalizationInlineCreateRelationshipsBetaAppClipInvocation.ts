...
export class BetaAppClipInvocationLocalizationInlineCreateRelationshipsBetaAppClipInvocation {
    ...
    static getAttributeTypeMap() {
        return BetaAppClipInvocationLocalizationInlineCreateRelationshipsBetaAppClipInvocation.attributeTypeMap;
    }
}
