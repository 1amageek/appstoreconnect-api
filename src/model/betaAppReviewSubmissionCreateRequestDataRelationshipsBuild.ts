...
export class BetaAppReviewSubmissionCreateRequestDataRelationshipsBuild {
    ...
    static getAttributeTypeMap() {
        return BetaAppReviewSubmissionCreateRequestDataRelationshipsBuild.attributeTypeMap;
    }
}
