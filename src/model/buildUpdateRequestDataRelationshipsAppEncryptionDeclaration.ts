...
export class BuildUpdateRequestDataRelationshipsAppEncryptionDeclaration {
    ...
    static getAttributeTypeMap() {
        return BuildUpdateRequestDataRelationshipsAppEncryptionDeclaration.attributeTypeMap;
    }
}
