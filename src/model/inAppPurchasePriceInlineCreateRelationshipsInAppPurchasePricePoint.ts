...
export class InAppPurchasePriceInlineCreateRelationshipsInAppPurchasePricePoint {
    ...
    static getAttributeTypeMap() {
        return InAppPurchasePriceInlineCreateRelationshipsInAppPurchasePricePoint.attributeTypeMap;
    }
}
