...
import { ScmRepositoryRelationshipsScmProviderData } from './scmRepositoryRelationshipsScmProviderData';

export class ScmRepositoryRelationshipsScmProvider {
    ...
    static getAttributeTypeMap() {
        return ScmRepositoryRelationshipsScmProvider.attributeTypeMap;
    }
}
