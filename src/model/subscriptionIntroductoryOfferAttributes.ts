...
export class SubscriptionIntroductoryOfferAttributes {
    'startDate'?: string;
    'endDate'?: string;
    ...
    static getAttributeTypeMap() {
        return SubscriptionIntroductoryOfferAttributes.attributeTypeMap;
    }
}

export namespace SubscriptionIntroductoryOfferAttributes {
}
