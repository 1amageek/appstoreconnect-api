...
export class SubscriptionPromotionalOfferInlineCreateRelationshipsPrices {
    ...
    static getAttributeTypeMap() {
        return SubscriptionPromotionalOfferInlineCreateRelationshipsPrices.attributeTypeMap;
    }
}
