...
import { SubscriptionRelationshipsSubscriptionLocalizationsDataInner } from './subscriptionRelationshipsSubscriptionLocalizationsDataInner';

export class SubscriptionRelationshipsSubscriptionLocalizations {
    ...
    static getAttributeTypeMap() {
        return SubscriptionRelationshipsSubscriptionLocalizations.attributeTypeMap;
    }
}
